...
const photos = {
  heroFamily: assetPath('/hero-perro-gato.webp'),
  heroCare: assetPath('/hero-perro-chico.webp'),
  heroPlay: assetPath('/hero-perro.webp'),
  heroCat: assetPath('/hero-gato.webp'),
